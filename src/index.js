...
app.use(morgan('dev'));
app.use(bodyParser.urlencoded({extended: false}));//solo para  aceptar peticiones de datos sencillos, imagenes y otros no
app.use(bodyParser.json());//para que las peticiones puedan mandarse jsons
